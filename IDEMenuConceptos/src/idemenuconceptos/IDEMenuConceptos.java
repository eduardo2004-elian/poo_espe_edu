package idemenuconceptos;
import java.util.Scanner;
public class IDEMenuConceptos {
    public static void main(String[] args) {
        Scanner scanner = new Scanner(System.in);
        boolean salir = false;
        while (!salir) {
            System.out.println("===================================================");
            System.out.println("Meno de Opciones:");
            System.out.println("[1] Conocer que es un IDE");
            System.out.println("[2] Saber para que sirve un IDE");
            System.out.println("[3] Conocer las ventajas de los IDE");
            ...
            scanner.nextLine(); // Consumir nueva línea después de leer un número
            switch (opcion) {
                case 1:
                    System.out.println("========================================================================================================================================");
                    System.out.println("QUE ES UN ENTORONO DE DESARROLLO INTEGRADO?");
                ...
                case 2:
                    System.out.println("========================================================================================================================================");
                    System.out.println("PARA QUE SIRVE UN IDE?");
                ...
                case 3:
                    System.out.println("========================================================================================================================================");
                    System.out.println("CUALES SON LAS VENTAJAS DE UTILIZAR UN IDE?");
